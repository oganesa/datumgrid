...
type Props = {
  ...
  onClose: () => void;
  onSuccess?: () => void;
  editItem?: SerializedVendor | null;
};
...
export default function NewVendorModal({ isOpen, onClose, onSuccess, editItem }: Props) {
  ...
  useEffect(() => {
    ...
    listContactsByOwner("vendor", editItem._id).then(setContacts);
  }, [isOpen, editItem]);
  ...
  async function onSubmitForm(e: React.FormEvent<HTMLFormElement>) {
    ...
    const result = isEdit
      ? await updateVendor(editItem!._id, formData)
  ...
  async function saveContact() {
    ...
    const result = editingContactId
      ...
      : await createContact("vendor", editItem._id, fd);
