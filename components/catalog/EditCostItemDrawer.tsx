  ...
  return (
    <>
      <button
        ...
        onClick={onClose}
      />
      <aside className="fixed right-0 top-0 z-[56] flex h-full w-full max-w-md flex-col border-l border-[#E5EAF2] bg-white shadow-xl">
        <div className="flex items-center justify-between border-b border-[#E5EAF2] bg-[#4A90E2] p-4 text-white">
        ...
        <div className="border-b border-[#E5EAF2] bg-[#EBF3FF] p-3 text-xs text-gray-800">
        ...
        >
          ...
          <div className="mt-auto flex justify-end gap-3 border-t border-[#E5EAF2] pt-4">
            <button
              type="button"
              onClick={onClose}
